...
const Hero = () => {
  return (
    ...
    <div className="flex pt-10 justify-center items-center space-x-32">
      <div className="w-center">
        <div className="flex">
          <h1 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-5xl"><br/>

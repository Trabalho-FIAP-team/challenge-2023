...
const EventCard = ({ event }: { event: EventCardProps }) => {
  return (
    <div className="w-65 p-2 bg-muted-foreground/10 rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl ">
        ...
        />
        <div className="p-2">
        <h2 className="font-bold text-lg mb-2 ">Evento A</h2>
        <p className="text-sm text-gray-600 dark:text-gray-100">Venha participar de uma palestra enriquecedora sobre o compromisso da Schneider...</p>
        </div>

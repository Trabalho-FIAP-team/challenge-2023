...
const EventsPage = () => {
    return (
      <main>
        <h1 className="mt-10 text-3xl font-extrabold text-gray-900 flex justify-center dark:text-white md:text-5xl lg:text-5xl">Todos os eventos</h1>
        <div className='w-11/12 mt-12 gap-6 flex-wrap grid md:grid-cols-3 lg:grid-cols-4 sm:grid-cols-2 justify-center items-center md:ml-20 '>
          {events.map((event) => (

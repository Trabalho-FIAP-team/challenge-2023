        ...
        <Body className="mx-auto bg-zinc-50 font-sans">
          <Container className="mx-auto my-[40px] max-w-2xl rounded p-4">
            ...
            <Section className="mt-4 text-center text-zinc-400">
              <Text className="my-4">
                &ldquo;A melhor maneira de começar é começar.&rdquo; Marque sua participação no evento EcoConnect e esteja pronto para uma experiência enriquecedora. Você ficará surpreso com o que aprenderá! 🌟
                <Link
